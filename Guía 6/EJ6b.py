# Ejercicio 6a:
# Discretizar la siguiente ecuación diferencial con valores de contorno utilizando operadores de derivada de orden 1 y 2:
# 0.1y'' + y' + y = 0
# y(0) = 0
# y(1) = 1
# Estimar los valores del intervalo dado con un paso de 0.1
...
def fc(x):
    return np.array([[ 0.1/h**2], [ 1 - 1/h - 0.2/h**2], [ 1/h + 0.1/h**2]], dtype = float)
...
ax.set_title('Operadores de orden 1 y 2, con h=%f' % h, loc='left')
