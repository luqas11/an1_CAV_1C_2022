# Ejercicio 10:
# Integrar la siguiente función en el intervalo (1, 2) utilizando el método de Romberg con una precisión de 4 dígitos significativos:
# f(x) = 1/x
...
print("Resultado exacto: 0.6931471805")
